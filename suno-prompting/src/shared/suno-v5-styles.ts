...
/**
 * Type representing any valid Suno V5 style
 */
 ...
 */
const SUNO_V5_STYLES_SET: ReadonlySet<string> = new Set(SUNO_V5_STYLES);

/**
 * Check if a style is a valid Suno V5 style.
 * Type guard function for runtime validation.
 * Uses Set for O(1) lookup performance.
 *
 * @param style - The style string to check
 * @returns True if the style is a valid Suno V5 style
 */
export function isSunoV5Style(style: string): style is SunoV5Style {
  return SUNO_V5_STYLES_SET.has(style);
}
