...
export const INSTRUMENT_REGISTRY: readonly InstrumentEntry[] = [
  ...
  { canonical: 'bass flute', category: 'color', aliases: ['contrabass flute'] },
  ...
  { canonical: 'slapstick', category: 'movement', aliases: ['whip', 'whip crack'] },
  { canonical: 'ondes Martenot', category: 'rare', aliases: ['ondes martenot', 'Martenot'] },
