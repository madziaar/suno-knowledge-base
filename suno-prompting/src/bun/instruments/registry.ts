...
export const INSTRUMENT_REGISTRY: readonly InstrumentEntry[] = [
  ...
  { canonical: 'bass', category: 'movement', aliases: ['bass guitar', 'electric bass'] },
  { canonical: 'upright bass', category: 'movement', aliases: ['contrabass', 'double bass', 'acoustic bass'] },
