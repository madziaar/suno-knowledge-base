...
def test_layout_file_written_with_default_gap_mode(tmp_path: Path, monkeypatch) -> None:
...
def test_layout_file_honors_gapless_frontmatter(tmp_path: Path, monkeypatch) -> None:
    _write_sine_wav(tmp_path / "01-a.wav")
    _write_sine_wav(tmp_path / "02-b.wav", freq=330.0)
    _install_album(
        monkeypatch,
