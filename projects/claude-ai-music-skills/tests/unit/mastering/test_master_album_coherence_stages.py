...
def test_coherence_correct_clamps_when_target_below_window(
    ...
    def _fake_plan(
        classifications, analysis_results, anchor_index_1based, max_tilt_db=None
    ):
        return {
            ...
            "skipped": [
                {"index": 1, "filename": "01-anchor.wav", "reason": "is_anchor"}
            ],
        }
    ...
    def _fake_plan(
        ...
        return {
            ...
            "corrections": [
                ...
                {
                    "index": 3,
                    "filename": "03-drift.wav",
                    "correctable": True,
                    "corrected_tilt_db": 0.2,
                    "tilt_clamped": False,
                    "intended_tilt_db": 0.2,
                    "limiting_metric": "low_rms_db",
                    "spectral_delta_db": 0.2,
                    "reason": "spectral",
                },
            ],
            "skipped": [
