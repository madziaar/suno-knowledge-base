...
def _standard_ideas_md(
    title: str, genre: str, concept: str, status: str = "Pending"
) -> str:
...
class TestPromoteIdeaSlugDerivation:
    def test_auto_derives_slug_from_simple_title(
        ...
        _write_ideas_md(
            content_root,
            _standard_ideas_md(
                "Midnight Drive", "electronic", "Neon-lit highway tales."
            ),
        )
    ...
    def test_strips_diacritics(self, content_root: Path, setup_handler):
        ...
        _write_ideas_md(
            content_root,
            _standard_ideas_md(
                "Ängstliche Kätzchen", "folk", "Scared kittens, gentle folk."
            ),
        )
    ...
    def test_strips_punctuation(self, content_root: Path, setup_handler):
        ...
        _write_ideas_md(
            content_root,
            _standard_ideas_md(
                "Who's Next? The Reckoning!", "rock", "Punctuation torture test."
            ),
        )
    ...
    def test_explicit_slug_overrides_auto(self, content_root: Path, setup_handler):
        ...
        result = json.loads(
            _run(_ideas_mod.promote_idea("Kleine Welt", album_slug="custom-slug"))
        )
...
class TestPromoteIdeaErrors:
    ...
    def test_already_promoted_idea_returns_error(
        self, content_root: Path, setup_handler
    ):
...
class TestPromoteIdeaDocumentary:
    def test_documentary_creates_research_files(
        self, content_root: Path, setup_handler
    ):
        setup_handler(
            [
        ...
        result = json.loads(
            _run(_ideas_mod.promote_idea("The Heist", documentary=True))
        )
...
class TestPromoteIdeaMaliciousSlug:
    ...
    def test_rejects_path_traversal_slug(
        ...
        result = json.loads(
            _run(_ideas_mod.promote_idea("Kleine Welt", album_slug=bad_slug))
        )
