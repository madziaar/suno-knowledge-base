...
class TestPolishAudio:
    ...
    def test_missing_deps_returns_error(self, tmp_path):
        with patch.object(
            _helpers_mod, "_check_mixing_deps", return_value="deps missing"
        ):
    ...
    def test_missing_audio_dir_returns_error(self, tmp_path):
        with patch.object(
            _helpers_mod, "_check_mixing_deps", return_value=None
        ), patch.object(
            _helpers_mod,
            "_resolve_audio_dir",
            return_value=('{"error": "not found"}', None),
        ):
    ...
    def test_full_mix_mode(self, tmp_path):
        ...
        with patch.object(
            ...
            _helpers_mod, "_resolve_audio_dir", return_value=(None, audio_dir)
        ):
