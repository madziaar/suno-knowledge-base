...
def _find_track_or_error(
    tracks: dict[str, Any], track_slug: str, album_slug: str = ""
) -> tuple[str, dict[str, Any] | None, str | None]:
...
_CODE_BLOCK_SECTIONS = frozenset(
    {"Style Box", "Exclude Styles", "Lyrics Box", "Streaming Lyrics", "Original Quote"}
)
