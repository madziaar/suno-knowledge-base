                ...
                return _safe_json(
                    {
                        ...
                        "available_tracks": sorted(
                            [d.name for d in stems_dir.iterdir() if d.is_dir()]
                        ),
                    }
                )
...
async def polish_album(
    ...
    polished_files = sorted(
        [f for f in polished_dir.iterdir() if f.suffix.lower() == ".wav"]
    )
