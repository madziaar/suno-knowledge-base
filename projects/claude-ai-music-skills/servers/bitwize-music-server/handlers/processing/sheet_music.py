...
async def prepare_singles(
    ...
    if prepare_mod is None:
        return _safe_json(
            {"error": "Sheet music prepare_singles module not available."}
        )
    ...
    if songbook_mod is None:
        return _safe_json(
            {"error": "Sheet music create_songbook module not available."}
        )
...
async def create_songbook(
    ...
    if success:
        ...
        return _safe_json(
            {"error": "Songbook creation failed. Check sheet music directory."}
        )
        ...
        return _safe_json(
            {
                ...
                "checked_dirs": [str(sheet_music_dir / s) for s in subdirs_to_scan],
