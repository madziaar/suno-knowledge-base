...
9. **Promo Copy** (optional) - `promo/` directory has platform copy populated (campaign.md, twitter.md, instagram.md, etc.). Use ``promo-writer` skill` to generate copy from album themes, or fill in templates manually. Note: ``promo-director` skill` generates promo *videos*, not social copy.
...
6. **Social media copy** (optional) - `promo/` files populated for target platforms (use ``promo-writer` skill` to generate copy from album themes, or fill in templates manually; ``promo-director` skill` generates videos, not copy)
...
[Click to tweet about your release](https://twitter.com/intent/tweet?text=Just%20released%20%22{URL_ENCODED_NAME}%22%20🎵%20Made%20with%20Codex%20AI%20Music%20Skills%20%23CodexCode%20%23SunoAI%20%23AIMusic%20%40bitwizemusic)

Or manually: #CodexCode #SunoAI #AIMusic @bitwizemusic
...
[Click to tweet about your release](https://twitter.com/intent/tweet?text=Just%20released%20%22Your%20Album%22%20🎵%20Made%20with%20Codex%20AI%20Music%20Skills%20%23CodexCode%20%23SunoAI%20%23AIMusic%20%40bitwizemusic)
