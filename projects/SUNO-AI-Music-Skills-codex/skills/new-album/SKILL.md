...
Valid genres: Any genre that has a directory under `this skill package root/genres/`. Use the slug form (lowercase, hyphenated) — e.g. `deep-house`, `crust-punk`, `k-pop`, `hip-hop`.

To check if a genre is valid, verify `this skill package root/genres/{genre}/README.md` exists.
...
Next steps:
  Option 1 - Interactive (Recommended):
    Run `album-conceptualizer` skill to design your album concept
...
Expected at: this skill package root/templates/
```
