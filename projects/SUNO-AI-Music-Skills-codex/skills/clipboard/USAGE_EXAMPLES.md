...
Platform-specific examples and troubleshooting for the ``clipboard` skill` skill.
...
```bash
`clipboard` skill lyrics my-album 03
```
...
```bash
`clipboard` skill style my-album 05
```
...
```bash
`clipboard` skill all my-album 01
```
...
```bash
`clipboard` skill streaming-lyrics my-album 02
```
...
- [this skill package root/reference/suno/v5-best-practices.md](this skill package root/reference/suno/v5-best-practices.md) - Suno prompting guide
