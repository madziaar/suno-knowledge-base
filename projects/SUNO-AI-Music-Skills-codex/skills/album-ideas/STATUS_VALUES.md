...
Reference for status tracking in the ``album-ideas` skill` skill.
...
- You run ``new-album` skill [title] [genre]`
...
```bash
`album-ideas` skill status "Album Title" in-progress
`album-ideas` skill status "Album Title" complete
`album-ideas` skill status "Album Title" pending
```

### Check Specific Idea

```bash
`album-ideas` skill show "Album Title"
```
...
- [this skill package root/templates/ideas.md](this skill package root/templates/ideas.md) - IDEAS.md template
