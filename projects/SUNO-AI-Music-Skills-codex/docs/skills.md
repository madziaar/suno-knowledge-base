...
All 52 skills, invoked with `/bitwize-music:<skill-name>`. Codex also uses them automatically when relevant.
...
| `skill-model-updater` | Update Codex model references across skills |
