...
Quick lookup for all configuration options. Full documentation: [this skill package root/config/README.md](this skill package root/config/README.md).
...
For ``sheet-music-publisher` skill`:
...
Provider-specific keys documented in [this skill package root/reference/cloud/setup-guide.md](this skill package root/reference/cloud/setup-guide.md).
...
```bash
# Show current config
`configure` skill show

# Edit a specific setting
`configure` skill edit

# Validate config for issues
`configure` skill validate

# Start fresh
`configure` skill reset
```
...
See [this skill package root/config/config.example.yaml](this skill package root/config/config.example.yaml) for complete example with all options.
...
- [this skill package root/config/README.md](this skill package root/config/README.md) - Complete config reference with examples
- [this skill package root/config/config.example.yaml](this skill package root/config/config.example.yaml) - Example config file
