...
See also: `this skill package root/reference/workflows/album-planning-phases.md`
...
Discuss visual concept early — actual generation happens later via ``album-art-director` skill`.
...
4. `tracks/XX-track-name.md` - Individual track files
   ...
   - Workflow routing: instrumental tracks go directly to ``suno-engineer` skill` (no lyric-writer/reviewer/pronunciation)
