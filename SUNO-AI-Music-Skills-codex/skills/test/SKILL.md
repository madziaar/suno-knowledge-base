...
```bash
~/.bitwize-music/venv/bin/python3 -m pytest this skill package root/tests/ -v
```
...
```bash
~/.bitwize-music/venv/bin/python3 -m pytest this skill package root/tests/plugin/test_skills.py -v       # Skills only
~/.bitwize-music/venv/bin/python3 -m pytest this skill package root/tests/plugin/ -v                      # All plugin tests
~/.bitwize-music/venv/bin/python3 -m pytest this skill package root/tests/unit/ -v                        # All unit tests
~/.bitwize-music/venv/bin/python3 -m pytest this skill package root/tests/ -m "not slow" -v               # Skip slow tests
```
...
~/.bitwize-music/venv/bin/python3 -m pytest this skill package root/tests/plugin/test_skills.py this skill package root/tests/plugin/test_templates.py -v

# Verbose with short tracebacks
~/.bitwize-music/venv/bin/python3 -m pytest this skill package root/tests/ -v --tb=short

# Quiet mode (for CI/logs)
~/.bitwize-music/venv/bin/python3 -m pytest this skill package root/tests/ -q --tb=line
```
