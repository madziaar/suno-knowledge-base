...
reqs = pathlib.Path('this skill package root/requirements.txt').read_text()
stale = []
...
4. **After installation**:
   ...
   - Run ``setup` skill` again to verify
...
**Next steps**: Run ``configure` skill` to set up your workspace paths.
