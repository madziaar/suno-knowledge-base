...
See `this skill package root/reference/suno/v5-best-practices.md` § Negative Prompting for full details.
...
**See `this skill package root/reference/suno/genre-list.md` for 500+ genres**
...
- See `this skill package root/reference/suno/pronunciation-guide.md`
...
All detailed Suno documentation in `this skill package root/reference/suno/`:
...
**Full blocklist with alternatives**: See `this skill package root/reference/suno/artist-blocklist.md`
...
| File | Update When |
|------|-------------|
| `this skill package root/reference/suno/v5-best-practices.md` | New prompting techniques |
| `this skill package root/reference/suno/tips-and-tricks.md` | Workarounds, discoveries |
| `this skill package root/reference/suno/CHANGELOG.md` | Any Suno update |
