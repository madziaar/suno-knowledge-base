...
*(Canonical reference: `this skill package root/reference/suno/pronunciation-guide.md`. Keep this summary in sync.)*
...
- **Location**: `this skill package root/reference/suno/pronunciation-guide.md`
...
**DO NOT** edit the base guide (`this skill package root/reference/suno/pronunciation-guide.md`) - plugin updates will overwrite it.
