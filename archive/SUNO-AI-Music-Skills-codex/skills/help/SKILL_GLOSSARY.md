...
### Skill
A slash command that invokes specialized functionality. Skills are invoked with ``skill-name` skill`. Each skill has its own SKILL.md documentation in `this skill package root/skills/[skill-name]/`.
...
| `this skill package root` | (location of plugin) | `~/.claude/plugins/bitwize-music` |
