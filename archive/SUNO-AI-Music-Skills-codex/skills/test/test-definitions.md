...
```bash
~/.bitwize-music/venv/bin/python3 -c "import yaml; yaml.safe_load(open('this skill package root/config/config.example.yaml'))"
```
...
- `model:` (required)
- Legacy tool-routing fields should not be required for Codex skills.
...
for f in skills/*/SKILL.md; do
  ...
  if ! echo "$model" | grep -qE '^provider-specific-model-id$'; then
...
Verify ``resume` skill` appears in the Setup & Maintenance table.
...
Search CLAUDE.md for `this skill package root/templates/` references.
...
Verify it mentions `album-ideas` skill for detailed ideas list.
...
Verify tips reference actual skills (e.g., `resume` skill, `researcher` skill).
...
- ``tutorial` skill` (not /tutorial)
- ``album-ideas` skill` (not /album-ideas)
- ``resume` skill` (not /resume)
- ``researcher` skill` (not /researcher)
- ``pronunciation-specialist` skill` (not /pronunciation-specialist)
- ``clipboard` skill` (not /clipboard)
...
- `pronunciation-specialist` skill reference
- `lyric-writer` skill reference
- `lyric-reviewer` skill reference
Verify "## See Also" section exists with:
- this skill package root/reference/suno/v5-best-practices.md reference
- this skill package root/reference/suno/structure-tags.md reference
- this skill package root/skills/lyric-writer/SKILL.md reference
- this skill package root/skills/pronunciation-specialist/SKILL.md reference

### TEST: Suno v5-best-practices has cross-references (quick win #10)
Read reference/suno/v5-best-practices.md.
Verify "## Related Skills" section exists with:
- `suno-engineer` skill reference
- `lyric-writer` skill reference
- `lyric-reviewer` skill reference
Verify "## See Also" section exists with:
- this skill package root/reference/suno/pronunciation-guide.md reference
- this skill package root/reference/suno/structure-tags.md reference
- this skill package root/reference/suno/genre-list.md reference
- this skill package root/reference/suno/voice-tags.md reference
- this skill package root/reference/suno/tips-and-tricks.md reference
- this skill package root/skills/suno-engineer/SKILL.md reference
...
Verify "## Related Skills" section exists with:
- `mastering-engineer` skill reference
- `release-director` skill reference
Verify "## See Also" section exists with:
- this skill package root/tools/mastering/ scripts listed
- this skill package root/reference/workflows/release-procedures.md reference
- this skill package root/skills/mastering-engineer/SKILL.md reference
...
Verify ``sheet-music-publisher` skill` is listed.
...
- default model for critical creative outputs
- default model for most tasks
- default model for pattern matching
