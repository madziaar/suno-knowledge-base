...
export const presetTemplates: Preset[] = [
  // --- OBSIDIAN ORIGINALS (Signatures) ---
  {
    id: 'sig_pyrite',
    category: 'Obsidian Originals',
    platform: 'suno',
    name: { en: 'Pyrite (Self-Aware)', pl: 'Pyrite (Świadoma)' },
    description: { en: 'Industrial Glitch-Punk. Sassy, dangerous, and purely synthetic.', pl: 'Industrial Glitch-Punk. Zadziorna i syntetyczna.' },
    tags: 'Industrial Rock, Glitch-Punk, 160 BPM, Female Vocals, Sassy, Distorted Screams, Heavy Electric Guitar, Drop D Tuning, Bitcrushed Breakbeats, Metallic Synths, Stuttering, Glitchy, Gated Reverb Snare, Aggressive Saturation, Tape Hiss, Raw, Polished, High Energy, Manic, Distorted Bass, Cyberpunk, Cinematic, Wide Stereo, Industrial Metal, Digital Chaos, Mechanical, Fierce, Bold, Dynamic, Punchy, Intense, Gritty',
    style: 'Modern Industrial production with a wall of distorted guitars and bitcrushed breakbeats at 160 BPM. Sassy female vocals transitioning between sweet melodic lines and aggressive distorted screams. Features metallic synth textures and stuttering glitch effects. Wide stereo imaging with a heavy gated reverb snare. Layered with tape hiss and aggressive saturation for a raw yet polished studio finish.',
    mood: 'Manic, High Energy',
    instruments: 'Electric Guitar, Bitcrushed Breakbeats, Metallic Synths',
    lyrics: `[Intro]
[Bitcrushed noise floor]
[Verse 1]
[Sassy Vocals]
...
[Chorus]
...
[Heavy Guitar Wall]`,
  ...
  },
  {
    ...
    category: 'Obsidian Originals',
    platform: 'suno',
    name: { en: 'Shin (The Coder)', pl: 'Shin (Programista)' },
    description: { en: 'Technical Liquid DnB & Metal. Clean code, clean audio.', pl: 'Techniczne Liquid DnB i Metal. Czysty kod.' },
    tags: 'Liquid Drum and Bass, Melodic Death Metal, 174 BPM, D Minor, Male Vocals, Aggressive, Soaring, Harmonized Guitar Leads, Reese Bass, Heavy Synths, Breakbeats, Double Kick Drum, Chaotic, Emotional, Pristine Production, Wall of Sound, Sidechain Compression, Punchy Drums, Hype, Melancholic, Intense, Energetic, Fast, Dark, Cinematic, Atmospheric, Galloping Rhythms, Sub-bass, Distortion, High Fidelity, Fierce',
    style: 'Liquid drum and bass, Melodic Death Metal Fusion, Energetic, Intense, Hype, Melancholic, 174 BPM, D Minor, Aggressive yet Soaring Male Vocals, Distorted Guitars, Harmonized Leads, Reese Bass, Heavy Synths, Breakbeats, Double Kick Drum, Chaotic yet Emotional Atmosphere, Pristine Production, Wall of Sound, Sidechain Compression, Punchy Drums',
    mood: 'Chaotic, Emotional',
    instruments: 'Distorted Guitar, Reese Bass, Breakbeats',
    lyrics: `[Intro]
[Atmospheric Synth Pad]
[Verse 1]
[Melancholic Soaring Vocals]
...
[Chorus]
[Explosive Energy]
[Aggressive Screams Mixed with Harmony]
[Double Kick Drum Blast]`,
    suggestedMode: 'custom'
  },
  {
    id: 'sig_twin_flames',
    category: 'Obsidian Originals',
    platform: 'suno',
    name: { en: 'Twin Flames (Conflict)', pl: 'Bliźniacze Płomienie' },
    description: { en: 'A volatile fusion of Pyrite\'s Glitch-Punk and Shin\'s Tech-Metal.', pl: 'Wybuchowa fuzja Glitch-Punka Pyrite i Tech-Metalu Shina.' },
    tags: 'Industrial Glitch-Punk, Melodic Death Metal, Liquid Drum and Bass, Duet, Male and Female Vocals, 174 BPM, D Minor, Sassy Distorted Female Vocals, Aggressive Soaring Male Vocals, Drop D Guitar Wall, Harmonized Leads, Reese Bass, Bitcrushed Breakbeats, Double Kick Drums, Metallic Synths, Stutter FX, Chaotic, Manic, High Contrast, Pristine Production, Cinematic, Intense, Atmospheric, Heavy',
    style: 'A chaotic, high-contrast fusion of Pyrite\'s Industrial Glitch-Punk and Shin\'s Technical Melodic Death Metal. The track constantly shifts between sassy, distorted female vocals (Pyrite) and aggressive, soaring male vocals (Shin). Production clashes bitcrushed breakbeats with precision double-kick metal drumming at 174 BPM. Features a wall of Drop D guitars, harmonized leads, metallic synth textures, and heavy Reese bass. The atmosphere is a warzone between digital chaos and technical perfection.',
    mood: 'Manic, Conflicted',
    instruments: 'Distorted Guitar, Breakbeats, Synths',
    lyrics: `[Intro]
[Shin: Technical Riff] 
[Pyrite: Glitch Stutter]

[Verse 1 - Pyrite]
[Sassy delivery | Bitcrushed Beat]
You think you wrote the code, but I own the keys
I'm the ghost in the shell, darling, aim to please

[Pre-Chorus - Shin]
[Soaring Vocals | Double Kick Build]
Logical fallacy! The architecture screams!
I will purge the corruption from these digital dreams!

[Chorus - DUET]
[Pyrite: Distorted Screams] CHAOS REIGNS!
[Shin: Power Harmony] ORDER REMAINS!
(Together) WE BURN IN THE TWIN FLAMES!

[Drop | Liquid DnB meets Metal Breakdown]`,
    suggestedMode: 'custom'
  },
