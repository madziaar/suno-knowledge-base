...
export const Select: React.FC<SelectProps> = ({
  ...
  const dropdownBg = isPyrite 
    ? 'bg-zinc-950/95 border-purple-500/30 shadow-2xl ring-1 ring-purple-500/20' 
    : 'bg-zinc-900/95 border-zinc-700 shadow-2xl ring-1 ring-white/10';
  ...
  return (
    <div className={cn("relative w-full", className)} ref={containerRef}>
      ...
      <div 
        ...
        className={cn(
            "w-full flex items-center justify-between rounded-xl px-3 py-2.5 text-xs md:text-sm transition-all duration-200 border cursor-pointer select-none", 
            triggerStyles
        )}
      >
