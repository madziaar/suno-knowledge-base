      ...
      <div className="flex gap-1">
          ...
          <button
              ...
              className={cn(
                  "p-3 rounded-xl border transition-all active:scale-95",
                  isPyriteMode 
                  ? 'bg-purple-600 text-white border-purple-500 shadow-[0_0_15px_rgba(168,85,247,0.4)] hover:shadow-[0_0_25px_rgba(168,85,247,0.6)] hover:bg-purple-500' 
                  : 'bg-zinc-100 text-black border-white hover:bg-white shadow-[0_0_15px_rgba(255,255,255,0.1)] hover:scale-105'
              )}
